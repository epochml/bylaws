...
* Nonvoting observers
  * **Shadow CTO/CSO:** Jishnu Thakkar
  * **Former board members and important alumni:**
    * Ethan Charoenpitaks
    * Andrew Bae
    * Georgi Panchev

Under General Provisions §4.4.4, we have decided to allocate 0.5 vote to each Shadow.

There are a total of 4 votes available. As per General Provisions §1.2, a minimum of 2.5 votes is required to pass future proposals.

Adopted 2026-03-08 by Board 6.
